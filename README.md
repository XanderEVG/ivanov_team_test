...
TODO (что не сделано, а хотелось бы)
----------------
1) Middlware - при постановке лайка - проверять что юзер залогинен
2) Middlware - при постановке входе - проверять что юзер НЕ залогинен
2) снятие лайка
3) Добавить лайки на страницу конкретного фильма
